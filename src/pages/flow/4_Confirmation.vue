        ...
        <section aria-labelledby="details-heading">
          ...
          <div class="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
            ...
            <div>
              ...
              <p class="mt-8 text-base text-gray-500">Up your snack organization game with multiple comparment options. The quick-access stash pouch is ready for even the most unexpected snack attacks and sharing needs.</p>
            </div>
          </div>
        </section>
